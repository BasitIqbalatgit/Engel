  ...
  const getFilteredAndSortedProducts = () => {
    let filtered = products.filter(product => {
      ...
      const matchesFilter = filterBy === 'all' || 
                           (filterBy === 'in-stock' && product.status === 'In Stock') ||
                           (filterBy === 'out-of-stock' && product.status === 'Out of Stock')
      ...
      <section className="relative bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-700 text-white py-16 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 opacity-90 max-w-3xl mx-auto">
            Discover {products.length} amazing products crafted with love and attention to detail
          </p>
                ...
                {viewMode === 'grid' ? (
                  <>
                    <div className="relative overflow-hidden">
                      ...
                      <div className={`absolute top-4 right-4 px-3 py-1 rounded-full text-sm font-semibold backdrop-blur ${
